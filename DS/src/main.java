import Entity.Ecole;
import Entity.Etudiant3eme;
import Entity.EtudiantAlternance;
import Entity.EtudiantExistException;
...
public class main {
    ...
    public static void main(String[] args)  {
        ...
        System.out.println("-------------------------------------------------");
        System.out.println("Moyenne 3A: " + ec.calculateMoyenne3A());
        System.out.println("Moyenne salaire Alternants: " + ec.calculateMoySalaireAlt());
        System.out.println("-------------------------------------------------");
